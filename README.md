...
- `frontend/` - React Native app with offline channels, queueing, sync UX, and modern UI tokens
- `frontend/UX_DESIGN.md` - modern UX system and interaction blueprint
- `backend/node/` - API gateway and transaction orchestration
- `backend/python/` - Fraud scoring microservice
- `infra/` - deployment docs, OpenAPI, and infrastructure manifests
...
- OpenAPI reference: `infra/docs/openapi.yaml`
...
See `infra/docs/deployment-guide.md` for AWS/GCP guidance, observability, scaling, secrets, and rollout.
